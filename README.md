...
The Daily Expense Tracker System (DETS) is a PHP-based web application that allows  registered users to record, view, and manage their daily personal expenses.
